...
{
    // number of messages
    private static final int NUMBER_MESSAGES = 50000;

    // possible enumerations - repeated enumerations make them more likely to be chosen
    private static final String CUSTOMERS[] =
    { "Joe Bloggs", "Fred Smith", "Ola Nordmann", "Walter Plinge", "Ola Nordmann", "Joe Bloggs", "Joe Bloggs", "Fred Smith" };
